...
namespace Vaquinha.Unit.Tests.ControllerTests
{
                                        ...
                                        IClassFixture<CartaoCreditoFixture>
    {
        ...
        private readonly DoadorViewModel _doadorViewModel;
        ...
        [Trait("DoacaoController", "DoacaoController_RecuperarDoadores_RetornaDadosComSucesso")]
        [Fact]
        public void DoacaoController_RecuperarDoadores_RetornaDadosComSucesso()
        {
            // Arrange            
            _doacaoController = new DoacoesController(_doacaoService, _domainNotificationService, _toastNotification.Object);

            // Act
            var retorno = _doacaoController.Index();
